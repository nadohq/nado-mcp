...
export function registerTransferQuote(
  ...
  server.registerTool(
    'transfer_quote',
    {
      ...
      description:
        'Transfer USDT between subaccounts under the same wallet. ' +
      ...
      inputSchema: {
        ...
        amount: z
          .number()
          .positive()
          .describe('Amount of USDT to transfer (e.g. 100 for 100 USDT)'),
      },
    ...
    async ({
      ...
      return asyncResult(
        'transfer_quote',
        `Failed to transfer ${amount} USDT to subaccount "${recipientSubaccountName}".`,
        () =>
